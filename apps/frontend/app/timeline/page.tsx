...
const MISSIONS = [
  ...
  { order: 5, round: 2, level: '2.2', name: 'The JWT Inception', type: 'WEB/TOKEN', difficulty: 'medium', points: 300, character: 'Vikram Singaravelan', characterImage: '/images/characters/vikram_urgent.png', bgImage: '/images/background/5.jpg', act: 'ROUND 2 — INFILTRATION', accentColor: '#f59e0b', accentRgb: '245,158,11', description: 'A hex-encoded JWT token guards the terrorist admin panel. Decode this multi-layered token to extract proof of government blackmail.' },
  ...
  { order: 7, round: 3, level: '3.1', name: 'The Payload Hunt', type: 'REVERSE ENG', difficulty: 'medium', points: 400, character: 'Veera Raghavan', characterImage: '/images/characters/veera_concerned.png', bgImage: '/images/background/7.jpg', act: 'ROUND 3 — FINAL STRIKE', accentColor: '#10b981', accentRgb: '16,185,129', description: 'The BLACKOUT payload is split across four encoding methods. Decode each fragment to reveal the activation mechanism and build the kill switch.' },

...
const MISSIONS = [
  { order: 1, round: 1, level: '1.1', name: 'The Intercepted Transmission', type: 'CRYPTOGRAPHY', difficulty: 'medium', points: 100, character: 'Veera Raghavan', characterImage: '/images/characters/veera_determined.webp', bgImage: '/images/background/1.webp', act: 'ROUND 1 — THE BREACH', accentColor: '#ef4444', accentRgb: '239,68,68', description: 'East Coast Mall is seized. Veera reaches basement telecom relay ER-42 and taps encrypted shortwave comms to identify patrol routes.' },
  { order: 2, round: 1, level: '1.2', name: 'The Fragmented Server Map', type: 'FORENSICS', difficulty: 'medium', points: 150, character: 'Preethi', characterImage: '/images/characters/preethi_worried.webp', bgImage: '/images/background/2.webp', act: 'ROUND 1 — THE BREACH', accentColor: '#ef4444', accentRgb: '239,68,68', description: 'Three encrypted file fragments hold the security door access codes for Server Room ER-42. Octal, Atbash, and inverted hex — assemble them before patrols return.' },
  { order: 3, round: 1, level: '1.3', name: 'The Time-Locked Vault', type: 'MATH/HASH', difficulty: 'hard', points: 200, character: 'Althaf Hussain', characterImage: '/images/characters/althaf_commanding.webp', bgImage: '/images/background/3.webp', act: 'ROUND 1 — THE BREACH', accentColor: '#ef4444', accentRgb: '239,68,68', description: 'A unique biometric vault uses your team\'s registration profile. Umar Saif\'s complete mall infiltration blueprint and C4 deployment map are locked inside.' },
  { order: 4, round: 2, level: '2.1', name: 'The Corrupted Hash Trail', type: 'HASH CRACKING', difficulty: 'medium', points: 250, character: 'Veera Raghavan', characterImage: '/images/characters/veera_intense.webp', bgImage: '/images/background/4.webp', act: 'ROUND 2 — INFILTRATION', accentColor: '#dc2626', accentRgb: '220,38,38', description: 'Three password-protected databases hold evidence of the terror network. MD5, SHA-1, SHA-256 — crack all three to uncover the Home Minister\'s collusion.' },
  { order: 5, round: 2, level: '2.2', name: 'The JWT Inception', type: 'WEB/TOKEN', difficulty: 'medium', points: 300, character: 'Preethi', characterImage: '/images/characters/preethi_hopeful.webp', bgImage: '/images/background/5.webp', act: 'ROUND 2 — INFILTRATION', accentColor: '#dc2626', accentRgb: '220,38,38', description: 'A hex-encoded JWT token guards the live admin feed. Decode this token to prove Home Minister Veera Santhanam staged his family\'s kidnapping.' },
  { order: 6, round: 2, level: '2.3', name: 'The Pattern Lock', type: 'CRYPTOGRAPHY', difficulty: 'hard', points: 350, character: 'Althaf Hussain', characterImage: '/images/characters/althaf_concerned.webp', bgImage: '/images/background/6.webp', act: 'ROUND 2 — INFILTRATION', accentColor: '#dc2626', accentRgb: '220,38,38', description: 'Override the communication relay so Veera can hijack the negotiation frequency and delay Farooq\'s border convoy. A SHA-256 challenge unique to your team.' },
  { order: 7, round: 3, level: '3.1', name: 'The Payload Hunt', type: 'REVERSE ENG', difficulty: 'medium', points: 400, character: 'Veera Raghavan', characterImage: '/images/characters/veera_concerned.webp', bgImage: '/images/background/7.webp', act: 'ROUND 3 — FINAL STRIKE', accentColor: '#b91c1c', accentRgb: '185,28,28', description: 'Saif\'s demolition payload is split across four encoding methods. Decode binary, hex, base64, and rot13 fragments to map the trigger mechanism.' },
  { order: 8, round: 3, level: '3.2', name: 'The Logic Bomb Defusal', type: 'NESTED DECODE', difficulty: 'hard', points: 450, character: 'Preethi', characterImage: '/images/characters/preethi_worried.webp', bgImage: '/images/background/8.webp', act: 'ROUND 3 — FINAL STRIKE', accentColor: '#b91c1c', accentRgb: '185,28,28', description: 'Saif has armed a fail-deadly explosive trigger on a 10-minute timer. Strip the nested encoding layers to defuse the logic bomb and evacuate all 1,200 hostages.' },
  { order: 9, round: 3, level: '3.3', name: 'The Master Vault', type: 'FINAL BOSS', difficulty: 'hard', points: 1000, character: 'Veera Raghavan', characterImage: '/images/characters/veera_relieved.webp', bgImage: '/images/background/9.webp', act: 'ROUND 3 — FINAL STRIKE', accentColor: '#b91c1c', accentRgb: '185,28,28', description: 'Fighter jet dogfight across hostile borders. Every technique you have learned converges here. Crack Farooq\'s Master Vault and terminate his global terror network.' },
];

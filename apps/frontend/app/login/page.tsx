...
import { ArrowLeft, Mail, Lock, AlertTriangle, LogIn, Eye, EyeOff, ShieldAlert, Skull, Crosshair } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError((err as Error).message || 'Authentication failed: Invalid credentials');
    } finally {
      setLoading(false);
    }
  };
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: 'auto' }}>
              <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#9ca3af', textDecoration: 'none', marginBottom: 28, fontSize: 11, letterSpacing: 2, fontWeight: 700, textTransform: 'uppercase', fontFamily: 'monospace' }}>
            ...
            >
              ...
              >
                ...
                <div style={{ textAlign: 'center' }}>
                  <Skull className="w-12 h-12 text-red-500 mx-auto mb-2 drop-shadow-[0_0_10px_#ef4444]" />
                  <div style={{ color: '#f87171', fontSize: 9, letterSpacing: 2, fontWeight: 700, fontFamily: 'monospace' }}>AUTHENTICATE</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div style={{ color: '#94a3b8', fontSize: 12, lineHeight: 1.6 }}>
                Secure authentication portal for certified operatives. Encrypted handshake via NSA terminal relay.
              </div>
              <div style={{ marginTop: 14, display: 'flex', gap: 10 }}>
                {['ENCRYPTED', 'TOP_SECRET', 'LEVEL_3'].map(tag => (
                  <div
                    key={tag}
                    style={{
                      padding: '3px 8px',
          ...
          >
            ...
            <div style={{ marginBottom: 28 }}>
              <div className="game-label" style={{ color: '#ef4444', marginBottom: 6 }}>◆ OPERATIVE VERIFICATION</div>
              ...
              <p style={{ color: '#94a3b8', fontSize: 13, lineHeight: 1.5 }}>
                Enter your authorized credentials to access the tactical operations dashboard.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <Mail size={16} color="#ef4444" style={{ position: 'absolute', left: 15, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', opacity: 0.7 }} />
                  <input
                    type="email"
                    ...
                    placeholder="operative@theextraction.cert"
                    required
                    autoComplete="email"
                  />
                </div>
            ...
            <div style={{ marginTop: 24, textAlign: 'center' }}>
              <span style={{ color: '#94a3b8', fontSize: 13 }}>New operative without credentials? </span>
            ...
            <div style={{ marginTop: 20, display: 'flex', alignItems: 'center', gap: 6, justifyContent: 'center' }}>
              ...
              <span style={{ color: '#6b7280', fontSize: 10, letterSpacing: 2, fontFamily: 'monospace' }}>SECURE SSL/TLS PROTOCOL</span>
            </div>
          </div>
        </div>
      </div>

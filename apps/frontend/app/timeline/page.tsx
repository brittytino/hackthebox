...
const MISSIONS = [
  ...
  { order: 8, round: 3, level: '3.2', name: 'The Logic Bomb Defusal', type: 'NESTED DECODE', difficulty: 'hard', points: 450, character: 'NSA Althaf', characterImage: '/images/characters/vikram_serious.png', bgImage: '/images/background/8.jpg', act: 'ROUND 3 — FINAL STRIKE', accentColor: '#10b981', accentRgb: '16,185,129', description: 'Saif has armed a fail-deadly explosive trigger. Five encoding layers deep — one wrong step and the mall goes up in flames tonight.' },
  ...
  return (
    <div ref={containerRef} style={{ minHeight: '100vh', background: 'linear-gradient(180deg, #080614 0%, #0a0818 40%, #080614 100%)', fontFamily: "'Inter', system-ui, sans-serif", overflow: 'auto', position: 'relative' }}>
      ...
      <div data-tl="header" style={{ textAlign: 'center', padding: '60px 24px 30px', position: 'relative', zIndex: 5 }}>
        <div style={{ color: '#6b7280', fontSize: 13, fontWeight: 700, letterSpacing: 6, marginBottom: 14, textTransform: 'uppercase' }}>The Hostage Crisis</div>
